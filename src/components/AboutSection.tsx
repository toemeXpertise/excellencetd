      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Excellence Tech Depot, votre partenaire de confiance depuis plus de 2 ans dans la vente d'appareils
            électroniques et les services financiers
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          <div>
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>
                Fondée avec la vision de démocratiser l'accès aux technologies modernes, Excellence Tech Depot s'est
                rapidement imposée comme une référence dans la vente d'appareils électroniques au Burkina Faso.
              </p>
              <p>
                Nous avons débuté avec une simple boutique et une conviction : offrir des produits de qualité à des prix
                accessibles. Aujourd'hui, nous sommes fiers d'avoir élargi notre offre aux services financiers avec
                Orange Money et les transferts d'argent.
              </p>
              <p>
                Notre engagement reste inchangé : accompagner nos clients dans leur transformation digitale en leur
                proposant les meilleures solutions technologiques et financières.
              </p>
            </div>
          </div>
          ...
          <div className="relative">
            <div className="bg-gradient-hero rounded-2xl p-8 text-white">
              ...
              <p className="text-lg leading-relaxed">
                "Rendre la technologie accessible à tous en proposant des produits innovants, des services financiers
                sécurisés et un accompagnement personnalisé."
              </p>
              <div className="mt-6 p-4 bg-white/10 rounded-lg">
                <p className="text-sm">
                  <strong>Vision 2025 :</strong> Devenir le leader incontournable des services technologiques et
            ...
            return (
              <Card key={index} className="text-center p-6 card-hover">
                <CardContent className="p-0">
                  <div
                    className={`mx-auto w-12 h-12 rounded-full bg-gradient-${stat.color} flex items-center justify-center mb-4`}
                  >
